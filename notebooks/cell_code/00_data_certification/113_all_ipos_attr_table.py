...
DATASET_LABEL = "Reference - IPOs"
SOURCE_URL = "https://polygon.io/docs/stocks/get_vx_reference_ipos"
...
FILE = Path(r"C:\\TSIS_Data\\data\\additional\\ipos\\all_ipos.parquet")
_show_attr_table(FILE, "all_ipos.parquet")
