...
DATASET_LABEL = "Short Data - Short Interest"
SOURCE_URL = "https://polygon.io/docs/stocks/get_v3_reference_tickers__ticker__short_interest"
...
FILE = Path(r"C:\\TSIS_Data\\data\\short_data\\short_interest\\AABA.parquet")
_show_attr_table(FILE, "short_interest/AABA.parquet")
