...
DATASET_LABEL = "Reference - Ticker Types"
SOURCE_URL = "https://polygon.io/docs/stocks/get_v3_reference_tickers_types"
...
FILE = Path(r"C:\\TSIS_Data\\data\\reference\\ticker_types.parquet")
_show_attr_table(FILE, "reference/ticker_types.parquet")
