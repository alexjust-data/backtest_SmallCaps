...
DATASET_LABEL = "Reference - Market Status"
SOURCE_URL = "https://polygon.io/docs/stocks/get_v1_marketstatus_upcoming"
...
_show_attr_table(FILE, "reference/market_status_upcoming.parquet")
