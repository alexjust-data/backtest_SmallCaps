...
DATASET_LABEL = "Reference - Ticker Events"
SOURCE_URL = "https://polygon.io/docs/stocks/get_vx_reference_tickers__ticker__events"
...
FILE = Path(r"C:\\TSIS_Data\\data\\additional\\corporate_actions\\ticker_events.parquet")
_show_attr_table(FILE, "ticker_events.parquet")
