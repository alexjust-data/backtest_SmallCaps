...
if not FILE.exists():
    for root in [Path(r"C:\\TSIS_Data\\data\\quotes_p95"), Path(r"C:\\TSIS_Data\\data\\quotes_p95_2019_2025"), Path(r"C:\\TSIS_Data\\data\\quotes_p95_2004_2018")]:
        if root.exists():
            cand = next(root.glob("*/year=*/month=*/day=*/quotes.parquet"), None)
            if cand is not None:
                FILE = cand
                break
_show_literal(FILE, "quotes.parquet")
