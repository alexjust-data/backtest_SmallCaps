...
DATASET_LABEL = "Economic - Treasury Yields"
SOURCE_URL = "https://massive.com/docs/rest/economy"
...
FILE = Path(r"C:\\TSIS_Data\\data\\additional\\economic\\treasury_yields.parquet")
_show_attr_table(FILE, "treasury_yields.parquet")
