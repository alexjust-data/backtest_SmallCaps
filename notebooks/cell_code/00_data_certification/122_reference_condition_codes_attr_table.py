...
DATASET_LABEL = "Reference - Condition Codes"
SOURCE_URL = "https://polygon.io/docs/stocks/get_v3_reference_conditions"
...
FILE = Path(r"C:\\TSIS_Data\\data\\reference\\condition_codes.parquet")
_show_attr_table(FILE, "reference/condition_codes.parquet")
