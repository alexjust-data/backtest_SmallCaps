...
DATASET_LABEL = "Reference - Exchanges"
SOURCE_URL = "https://polygon.io/docs/stocks/get_v3_reference_exchanges"
...
FILE = Path(r"C:\\TSIS_Data\\data\\reference\\exchanges.parquet")
_show_attr_table(FILE, "reference/exchanges.parquet")
