...
cands=[Path(r"C:\\TSIS_Data\\data\\additional\\corporate_actions\\dividends.parquet"), Path(r"C:\\TSIS_Data\\data\\additional\\dividends.parquet"), Path(r"C:\\TSIS_Data\\data\\corporate_actions\\dividends.parquet")]
FILE = next((c for c in cands if c.exists()), Path())
_show_literal(FILE, "dividends.parquet")
