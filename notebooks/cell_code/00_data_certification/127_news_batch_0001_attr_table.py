...
DATASET_LABEL = "News - Stocks News"
SOURCE_URL = "https://polygon.io/docs/stocks/get_v2_reference_news"
...
FILE = Path(r"C:\\TSIS_Data\\data\\additional\\news\\news_batch_0001.parquet")
_show_attr_table(FILE, "news_batch_0001.parquet")
